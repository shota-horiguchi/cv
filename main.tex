...
\section{Work Experiences}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Speaker recognition in multi-talker environments (2024--Present)}
      \resumeItemListEnd
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Meeting transcription using asynchronous distributed microphones (2019--2023)}
...
\section{Awards}
  \resumeItemListStart
    \resumeItem{IEEE SPS Young Author Best Paper Award, 2025.}
    \resumeItem{IEEE SPS Japan Young Auhor Best Paper Award, 2025.}
    \resumeItem{Honorable Mention Award at IEEE Spoken Language Technology Workshop, 2024.}
